	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')}<!--  - Powered By <a href="www.lb-tech.net" target="_blank">lb-tech</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
